...
- Ref prompt kết bằng mệnh đề `clean frame free of watermarks, logos, or AI icons` (KAIZEN 2026-07-09) — ảnh ingredient cũng là ảnh generate, cũng có thể bị model vẽ icon AI/watermark vào.
